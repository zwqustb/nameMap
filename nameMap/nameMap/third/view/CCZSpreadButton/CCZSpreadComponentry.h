...
@protocol ButtonGestureDelegate<NSObject>
@optional
-(void)panEnd:(CGPoint)ptLoc;
@end
...
//zwqbgn
@property(nonatomic,assign)CGRect rtPopBounds;//弹出按钮的限制区域
@property(nonatomic,assign)CGPoint ptScrollOffset;//父view是scrollview的偏移量
